<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Genres/GenreMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateGenre.aspx.cs" Inherits="LibraryManagementSystem.Pages.Genres.UpdateGenre" %>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group col-lg-6 alert alert-success" runat="server" id="divSuccess" visible="false" >
                                ...
                                <p>
                                    <strong>Well done!...</strong>The genre: <asp:Label ID="lblNewGenre" runat="server" Text="" Font-Bold="true"></asp:Label>
