<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Publishers/PublisherMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdatePublisher.aspx.cs" Inherits="LibraryManagementSystem.Pages.Publishers.UpdatePublisher" %>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div class="form-group col-lg-6 alert alert-success" runat="server" id="divSuccess" visible="false">
                                ...
                                <p>
                                    <strong>Well done!...</strong>Publisher: <asp:Label ID="lblNewPublisher" runat="server" Text="" Font-Bold="true"></asp:Label>
