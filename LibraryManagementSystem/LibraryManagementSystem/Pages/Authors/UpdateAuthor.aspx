<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Authors/AuthorMaster.Master" AutoEventWireup="true" CodeBehind="UpdateAuthor.aspx.cs" Inherits="LibraryManagementSystem.Pages.Authors.UpdateAuthor" %>
                        ...
                        <div class="body">
                            ...
                            <label for="biography" class="labels">Biography</label>
                              ...
                              <div class="form-group col-lg-6 alert alert-success" runat="server" id="divSuccess" visible="false">
                                ...
                                <p>
                                    <strong>Well done!...</strong>Info of author: <asp:Label ID="lblNewAuthor" runat="server" Text="" Font-Bold="true"></asp:Label>
